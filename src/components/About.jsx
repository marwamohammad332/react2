         ...
         style={{ background: '#1abc9c',minHeight:'80vh'}}>
            ...
            text-light">
                ...
                <div className="p-2">
                 ...
                 d-flex justify-content-center align-items-center p-2" href="#">
                        <svg style={{width:'17px'}}
                         class="svg-inline--fa fa-download me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                        ...
                        </svg> <i className="fas fa-download me-2"></i>
                        Free Download!
                    </a>
                </div>
