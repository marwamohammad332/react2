    ...
    return <>
        <div id="Contact" className="container py-5 mx-auto d-flex flex-column justify-content-center align-items-center gap-4"
            ...
            <form className="d-flex flex-column justify-content-center align-items-start gap-2"
                style={{ width: '40%' }}>
                <input className="form-control border-0 border-bottom" type="text" name="text"
                    placeholder="Full name" />
                <input className="form-control border-0 border-bottom" type="email" name="email"
                    placeholder="Email address" />
                <input className="form-control border-0 border-bottom" type="number" name="number"
                    placeholder="Phone number" />
                <textarea className="form-control border-0 border-bottom" placeholder="Message"></textarea>
                <button className="btn border-0 text-light btn-xl disabled"
